...
const HeroSection = () => {
  ...
  return (
    <section className={theme === 'light' ? 
      "relative min-h-screen lg:min-h-[calc(100vh-12rem)] pt-8 lg:pt-16 flex items-center justify-center overflow-hidden bg-background" : 
      "relative min-h-screen lg:min-h-[calc(100vh-12rem)] pt-8 lg:pt-16 flex items-center justify-center overflow-hidden"
    }>
