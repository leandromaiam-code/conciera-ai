...
const HeroSection = () => {
  ...
  return (
    <section className={theme === 'light' ? 
      "relative min-h-screen lg:min-h-[calc(100vh-4rem)] pt-4 lg:pt-6 flex items-center justify-center overflow-hidden bg-background" : 
      "relative min-h-screen lg:min-h-[calc(100vh-4rem)] pt-4 lg:pt-6 flex items-center justify-center overflow-hidden"
    }>
